			...
			<div class="row">
				<div class="col-md-8">
					<div class="mb-3">
							...
							<input type="text" class="form-control" id="edit-name" name="name" placeholder="Name of the game" required minlength="2" maxlength="255" value="<?php echo $category->name ?>">
						</div>
						<div class="mb-3">
							<label class="form-label" for="slug"><?php _e('Category Slug') ?>:</label>
							<input type="text" class="form-control" id="edit-slug" name="slug" placeholder="online-games" required minlength="2" maxlength="255" value="<?php echo $category->slug ?>">
						</div>
						<div class="mb-3">
